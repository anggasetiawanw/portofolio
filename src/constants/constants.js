export const projects = [
  {
    ...
    source: '',
    visit:
      'https://play.google.com/store/apps/details?id=id.pitik.mobile.mobile_flutter',
    id: 0,
  },
  {
...
export const TimeLineData = [
  ...
  { year: 2018, text: 'Worked intensively on Internet of Things' },
  { year: 2018, text: 'Learned Android app development.' },
  {
    year: 2019,
    text: 'Learned flutter app development and achievement as 1st winner IoT competiton.',
  },
  {
    year: 2020,
    text: 'Be a Mentor in Iot makers development program, and Creating some project flutter app',
  },
  {
    year: 2021,
    text: 'Finished Bachelor in Electrical Engineering and got my first job at Dana Purna Investamaa.',
  },
  {
    year: 2022,
    text: 'got my second job at Pitik Digital Indonesia as IoT Enginner',
  },
  {
    year: 2023,
    text: 'got my third job at Pitik Digital Indonesia as Mobile Enginner',
  },
  { year: 2024, text: 'year under progress....' },
];
